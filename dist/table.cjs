...
var TableHeader = ({ children }) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
  "thead",
  {
    ...
    children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("tr", { className: "border-b", style: { borderColor: "var(--border)" }, children })
  }
);
var TableColumn = ({ children }) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("th", { className: "px-4 py-2 font-medium font-sans", children });
var TableBody = ({ children }) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("tbody", { className: "text-sm text-(--text)", children });
var TableRow = ({ children }) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
  "tr",
  {
